...
class Car extends Factory {
    constructor(model /*super*/, doors, color /*super*/, engineType, transmission, trim /*super*/, wheelsTrim, audio, seatsTrim, moonroof) {
        super(model, color, trim)
        ...
        this.warranty = '100,000 miles / 5 years' // overwriting from Factory
    }
}
...
class Sport extends Car {
    constructor(model /*super*/, trim /*super*/, transmission /*super*/, top, color /*super*/, seatsTrim /*super*/, audio, wheelsTrim /*super*/) {
        super(model, 2 /*doors*/, color, 'gasoline' /*engineType*/, transmission, trim, wheelsTrim, audio, seatsTrim, false /*moonroof*/)
...
class Truck extends Factory {
    constructor(model /*super*/, color /*super*/, engineSize, hitch, bed, navigation, trim /*super*/, doors) {
        super(model, color, trim)
...
let mazda3 = new Car('mazda3', null /*doors*/, 'red', 'hybrid', 'automatic', 'touring' /*trim*/, 'base' /*wheelsTrim*/, 'premium', 'leather' /*seatsTrim*/, true)
...
let trailBlazer = new Truck('Trail Blazer', 'blue', 8, true, 'standard', true, 'Sport', 2)
